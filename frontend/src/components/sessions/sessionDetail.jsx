    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex space-x-2">
          <Link to="/sessions">
            <Button variant="light">Back to Sessions</Button>
          </Link>
          ...
          {isUpcoming() && (
            <>
              {session.zoomMeetingUrl && (
                ...
                >
                  <Button variant="primary">Join Zoom Meeting</Button>
                </a>
              )}
            </>
          )}
                ...
                {session.zoomMeetingVerified && (
                  <div className="col-span-2">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 flex items-center">
                      ...
                      Session verified through Zoom (
                      {session.verificationDetails?.meetingDuration} minutes,{" "}
                      {session.verificationDetails?.participantCount}{" "}
                      participants)
                    </dd>
                  </div>
                )}
          ...
          <Card title="Messages" className="mt-6">
            <div className="flex justify-center py-6">
              <div className="text-center">
                ...
                <Link
                  to={`/messages/${getUserType() === "professional" ? session.user._id : session.professional.user}`}
                >
                  <Button variant="primary">View Messages</Button>
                </Link>
              </div>
            </div>
          </Card>
          ...
          >
            {getUserType() === "professional" ? (
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm mb-4">
                  {session.professional.company?.name ||
                    session.professional.companyName}
                </p>
              </div>
            )}
            ...
            <div className="border-t border-gray-200 pt-4 mt-2">
              ...
              {session.zoomMeetingUrl ? (
                ...
                <p className="text-sm text-gray-600">
                  Zoom meeting details will be available once the session is
                  confirmed.
                </p>
              )}
            </div>
            ...
            <div className="space-y-4 text-sm">
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  Free cancellation up to 24 hours before the scheduled session
                  time. Cancellations made less than 24 hours in advance may be
                  subject to a fee.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  Payment is processed upon booking but only released to the
                  professional after the session is verified as completed
                  through Zoom.
                </p>
              </div>
            </div>
