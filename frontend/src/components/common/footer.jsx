        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mt-4 text-base text-gray-300">
              Connect with industry professionals anonymously for career guidance, 
              networking, and mentorship. Gain insights and build relationships 
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <Link to="/professionals" className="text-base text-gray-300 hover:text-white">
                  Find Professionals
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <Link to="/gdpr" className="text-base text-gray-300 hover:text-white">
                  GDPR Compliance
                </Link>
              </li>
            </ul>
